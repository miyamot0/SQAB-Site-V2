 ...
 * @param setError
 */
export function onSnapshotEventDocument<T>(
 ...
 * @param setError
 */
export function onSnapshotEventDocumentErr(
  err: unknown,
  setError: (value: React.SetStateAction<string | undefined>) => void,
): void {
 ...
 * @param setError
 */
export function onSnapshotEventCollection<T>(
 ...
 * @param setError
 */
export function onSnapshotEventCollectionErr(
  err: unknown,
  setError: (value: React.SetStateAction<string | undefined>) => void,
): void {
