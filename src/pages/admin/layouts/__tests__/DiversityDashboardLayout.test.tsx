...
describe('DiversityDashboardLayout', () => {
    ...
    it('Should render, good data', () => {
        act(() => {
            ...
            const wrapper = shallow(<DiversityDashboardLayout sysAdminFlag={sysAdminFlag} diversityReviewFlag={diversityReviewFlag} />)
        })
    })
    ...
    it('Should not render, quirky data', () => {
        act(() => {
            ...
            const mockDiv = jest.fn();
            mockDiv.mockReturnValue(Promise.resolve({
                data: {
