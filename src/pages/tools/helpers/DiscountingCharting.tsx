...
import { getbleichrodtProjection, getEbertPrelecProjection, getElementByModel, getExponentialProjection, getHyperbolicProjection, getMyersonProjection, getQuasiHyperbolicProjection, getRachlinProjection, getRodriguezLogueProjection } from "./DiscountingHelpers";
 ...
 */
export function handleDiscountingWorkerOutput({ ev, worker, setRunningCalculation, setResultsSummary,
    setButtonStatusMsg, setChartOptions }: handleDiscountingWorkerOutput): void {
    if (ev.data.done) {
