...
import { constructExponentialChart, constructExponentiatedChart, constructIHS2Chart, constructIHS3Chart, handleDemandWorkerOutput } from "../DemandCharting";
...
describe('handleDemandWorkerOutput', () => {
    it('Using good data: Exponential Model', () => {
        ...
        handleDemandWorkerOutput({ ev, worker, setRunningCalculation, setResultsSummary, setChartOptions })
    })
