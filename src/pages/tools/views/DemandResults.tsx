...
import { generateOutputScore, generateSlope, renderExponentialDemand, renderExponentiatedDemand, renderIHS2Demand, renderIHS3Demand } from "../helpers/DemandHelpers";
...
function generateStringOutputZBE3(row: string[], index: number): JSX.Element {
    ...
    const Q2 = renderIHS3Demand(rowInNumbers[0], rowInNumbers[1], rowInNumbers[2], rowInNumbers[3] * 1.01);
