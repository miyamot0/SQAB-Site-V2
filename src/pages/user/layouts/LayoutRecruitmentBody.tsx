                ...
                <MDBCard>
                    <MDBCardBody>
                        ...
                        <form>
                            <label>
                                <span>Name:</span>
                                <input required type="text" disabled value={state.Name}></input>
                            </label>
                            <label>
                                <span>Email:</span>
                                <input required type="text" disabled value={state.Contact}></input>
                            </label>
                            <label>
                            ...
                            <MDBBtn
                                ...
                                onClick={async () => {
                                    if (state.Name.length === 0 ||
                                        ...
                                        await handleEditRecruitmentSubmit(state, id,
                                            updateDocument, history, response);
                                    }
                                }}
                            >
                                Edit Profile
